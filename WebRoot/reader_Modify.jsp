...
<%}%> 
      ...
      <tr>
        ...
        <td><select name="paperType" class="wenbenkuang" id="paperType">
          <option value="Id Card"<%if("身份证".equals(paperType)) out.println(" selected");%>>ID Card</option>
          <option value="Stu Card"<%if("学生证".equals(paperType)) out.println(" selected");%>>Stu Card</option>
